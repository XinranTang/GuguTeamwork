...
if __name__=="__main__":
    # openID = input("OpenId:")
    # 这里改一下绝对路径
    results=readFronSqllite('C://Users//gmf//Desktop//微信小程序大赛//咕咕TeamWork//GuguTeamwork//GuguTeamwork//SQLite3//UserInfor.db'," select totalmanage,totaljoin,goingon from user_infor where ID = '"+'testopenid'+"'")
