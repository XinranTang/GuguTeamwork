...
func main() {
	...
	mux.HandleFunc("/gugu/setPersonal", fetch.SetPersonal)
	...
	mux.HandleFunc("/gugu/groupsta", fetch.GroupStatistics)
	mux.HandleFunc("/gugu/personalsta", fetch.PersonalStatistics)
	//WS服务
